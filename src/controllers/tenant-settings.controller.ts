 ...
 */
export const getTenantPreferences = async (req: Request, res: Response) => {
  try {
 ...
 */
export const updateTenantPreferences = async (req: Request, res: Response) => {
  try {
    const user = (req as any).user as JWTClaims;
 ...
 * Get 2FA settings
 */
export const get2FASettings = async (req: Request, res: Response) => {
  try {
    const user = (req as any).user as JWTClaims;
