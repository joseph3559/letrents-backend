...
export const propertyCaretakersController = {
  ...
  getPropertyCaretaker: async (req: Request, res: Response) => {
    try {
  ...
  assignCaretakerToProperty: async (req: Request, res: Response) => {
    try {
      const user = (req as any).user as JWTClaims;
      const { propertyId } = req.params;
  ...
  removeCaretakerFromProperty: async (req: Request, res: Response) => {
    try {
      const user = (req as any).user as JWTClaims;
      const { propertyId } = req.params;
