...
router.post(
  '/templates',
  rbacResource('checklists', 'create'),
...
router.put(
  '/templates/:id',
  rbacResource('checklists', 'update'),
...
router.delete(
  '/templates/:id',
  rbacResource('checklists', 'delete'),
...
router.post(
  '/inspections',
  rbacResource('checklists', 'create'),
  checklistsController.createInspection
);
...
router.get(
  '/inspections',
  rbacResource('checklists', 'read'),
  checklistsController.getInspections
);
...
router.get(
  '/inspections/:id',
  rbacResource('checklists', 'read'),
  checklistsController.getInspection
);
...
router.put(
  '/inspections/:id',
  rbacResource('checklists', 'update'),
  checklistsController.updateInspection
);
...
router.delete(
  '/inspections/:id',
  rbacResource('checklists', 'delete'),
  checklistsController.deleteInspection
);
...
router.put(
  ...
  rbacResource('checklists', 'update'),
  checklistsController.recordInspectionItem
);
...
router.post(
  ...
  rbacResource('checklists', 'update'),
  checklistsController.uploadInspectionPhoto
);
