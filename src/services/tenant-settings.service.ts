...
export class TenantSettingsService {
   ...
   */
  private async checkPermission(requestingUser: JWTClaims, targetUserId: string): Promise<boolean> {
   ...
   */
  async getUserPreferences(requestingUser: JWTClaims, targetUserId: string) {
    try {
   ...
   */
  async getUserNotificationSettings(requestingUser: JWTClaims, targetUserId: string) {
    try {
      const hasPermission = await this.checkPermission(requestingUser, targetUserId);
      if (!hasPermission) {
   ...
   */
  async getPreferences(user: JWTClaims) {
    try {
   ...
   */
  async updatePreferences(user: JWTClaims, data: any) {
    try {
   ...
   */
  async getNotificationSettings(user: JWTClaims) {
    try {
   ...
   */
  async updateNotificationSettings(user: JWTClaims, data: any) {
    try {
   ...
   */
  async changePassword(user: JWTClaims, currentPassword: string, newPassword: string) {
    try {
      // Get user
   ...
   */
  async getActiveSessions(user: JWTClaims, currentSessionId?: string) {
    try {
   ...
   */
  async revokeSession(user: JWTClaims, sessionId: string) {
    try {
   ...
   */
  async revokeAllOtherSessions(user: JWTClaims, currentSessionId: string) {
    try {
   ...
   */
  async getSecurityActivity(user: JWTClaims, limit: number = 20) {
    try {
   ...
   * Get 2FA settings
   */
  async get2FASettings(user: JWTClaims) {
    try {
   ...
   * Enable 2FA (SMS)
   */
  async enable2FA(user: JWTClaims, method: string, phoneNumber?: string) {
    try {
   ...
   * Disable 2FA
   */
  async disable2FA(user: JWTClaims, method: string) {
    try {
