...
export const handlePaystackWebhook = async (req, res) => {
    try {
        ...
        currency, customer, metadata, channel, // Payment channel: card, bank, ussd, qr, mobile_money, etc.
        ...
        let invoiceIds = Array.isArray(metadata?.invoice_ids)
                ...
                try {
                    ...
                    if (matches.length > 0) {
                        ...
                        console.warn('⚠️ invoice_ids missing; reconciled by unit_number fallback', {
                            ...
                            invoiceNumber: matches[0].invoice_number,
                        });
                    }
                }
                catch (e) {
