...
export class LeaseModificationsService {
     ...
     */
    async getModifications(query, user) {
     ...
     */
    async getLeaseModifications(leaseId, user) {
     ...
     */
    async createModification(data, user) {
     ...
     */
    async acknowledgeModification(modificationId, user) {
     ...
     */
    async getUnacknowledgedModifications(tenantId, user) {
     ...
     */
    async getModificationStats(leaseId, user) {
        ...
        modifications.forEach((mod) => {
            ...
            const daysSinceModification = (new Date().getTime() - new Date(mod.created_at).getTime()) /
                (1000 * 60 * 60 * 24);
     ...
     */
    async notifyTenantOfModification(modification, lease) {
        try {
            ...
            const changeDescription = this.formatChangeDescription(fieldLabel, modification.old_value, modification.new_value);
     ...
     */
    formatChangeDescription(field, oldValue, newValue) {
